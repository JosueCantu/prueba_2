...
# 2 "<built-in>" 2
# 1 "Programa_principal.c" 2
# 12 "Programa_principal.c"
...
# 13 "Programa_principal.c" 2

# 1 "./Configuracion.h" 1
# 14 "Programa_principal.c" 2

# 1 "./interrupciones_2.h" 1
# 37 "./interrupciones_2.h"
void Int_init(void);
void __attribute__((picinterrupt(("high_priority")))) INT0_ISR(void);
void __attribute__((picinterrupt(("low_priority")))) INT1_ISR(void);
# 15 "Programa_principal.c" 2
